...
import { AuthBtns } from "./TopNavbar/AuthBtns";
export function TopNavBar() {
  return (
    <header className="fixed top-0 left-0 right-0 border-b border-[#E5E5EC]">
      <div className="bg-black sticky">
        <p className="text-white text-xs p-1 text-center">
