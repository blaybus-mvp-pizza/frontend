...
export const queryKeys = {
  ...
  products: {
    ...
    endingSoon: (filters?: ProductFilters) => [...queryKeys.products.all, 'ending-soon', filters] as const,
    recommended: (filters?: ProductFilters) => [...queryKeys.products.all, 'recommended', filters] as const,
    new: (filters?: ProductFilters) => [...queryKeys.products.all, 'new', filters] as const,
    stores: {
      all: () => [...queryKeys.products.all, 'stores'] as const,
      recent: () => [...queryKeys.products.stores.all(), 'recent'] as const,
      list: (filters?: StoreFilters) => [...queryKeys.products.stores.all(), 'list', filters] as const,
    },
  },
